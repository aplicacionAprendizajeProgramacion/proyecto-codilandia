...
@Component({
  ...
  templateUrl: './nivel10.component.html',
  standalone: true,
  styleUrl: './nivel10.component.css'
})
export class Nivel10Component implements OnInit {
  correo_nino: string = '';
  nombre_nino: string = '';
  codigo_aula: string = '';
  num_nivel: number = 10;
  ...
  opciones2: string[] = [
    'Comprueba que i es menor que 10',
    'Incrementa el valor de i en 5',
  ...
  verificarPrueba2(): void {
    const opciones = ['suma = suma + 1;', 'suma++;'];
    ...
    this.correctos.comentario3 = this.numeroPasteles === 5;
  ...
  verificarPrueba4(): void {
    const correcto = 'Incrementa el valor de i en 1';
  ...
  verificarPrueba6(): void {
    const correcto = 'Dibuja 5 estrellas';
